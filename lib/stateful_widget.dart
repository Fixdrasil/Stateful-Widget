  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(children: [
        Image.network('https://www.yingpook.com/static/assets/uploads/wp-content/uploads/2016/09/shutterstock_446662645.jpg'),
        Container(
                  ...
                  Center(
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        color: Color.fromARGB(255, 247, 46, 1),
          ...
          children: [
            Column(
              children: const [
                Icon(
                  Icons.call_sharp,
                  color: Color.fromARGB(255, 12, 114, 192),
                ),
                SizedBox(
                  height: 10,
                ),
